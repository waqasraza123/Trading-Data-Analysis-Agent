...
/**
 * @deprecated Use `MotionPreset` values directly with `motionRevealPresetClass`, `AnimatedSection`,
 * or `AnimatedListItem`. This compatibility variant API remains for migration only.
 */
