      ...
      <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6">
        {setupStepOrder.map((step, index) => {
          ...
          return (
            ...
            >
              <button
                className={`rounded-md border px-3 py-2 text-left text-sm ${active ? "border-[var(--accent)] bg-[var(--accent-soft)] text-[var(--strong)]" : "border-[var(--line)] bg-[var(--panel)] text-slate-600 dark:text-slate-300"}`}
                type="button"
