...
operation as audit history. External provider calls are disabled by default, raw uploaded files are
not persisted, and raw provider secrets are not stored. See `docs/equity-data.md`.
