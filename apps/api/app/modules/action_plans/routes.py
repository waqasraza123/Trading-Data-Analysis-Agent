...
@router.post("/action-items/execute-due", response_model=ExecuteDueActionItemsResponse)
...
@router.post("/action-items/mark-due", response_model=MarkDueActionItemsResponse)
...
@router.post("/action-items/{action_item_id}/execute", response_model=ActionItemExecutionRead)
