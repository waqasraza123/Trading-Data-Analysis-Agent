...
class CandleAggregationRun(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("expected_base_candle_count >= 0", name="expected_base_candle_count_non_negative"),
        CheckConstraint("available_base_candle_count >= 0", name="available_base_candle_count_non_negative"),
        ...
        CheckConstraint("incomplete_window_count >= 0", name="incomplete_window_count_non_negative"),
        Index(
    ...
    expected_base_candle_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0, server_default=text("0"))
    available_base_candle_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0, server_default=text("0"))
    produced_candle_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0, server_default=text("0"))
    skipped_candle_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0, server_default=text("0"))
    incomplete_window_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0, server_default=text("0"))
...
class DerivedCandleLineage(Base):
    ...
    __table_args__ = (
        CheckConstraint("expected_base_count >= 0", name="derived_expected_base_count_non_negative"),
